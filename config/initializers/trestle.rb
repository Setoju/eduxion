Trestle.configure do |config|
  ...
  #
  config.site_title = "Eduxion Admin"
  ...
  # Dashboard menu item is defined in app/admin/dashboard_admin.rb
  # config.menu do
  #   group :navigation, priority: :first do
  #     item :dashboard, "/admin", icon: "fas fa-tachometer-alt", priority: :first
  #   end
  # end
